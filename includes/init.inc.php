...
require_once ROOT_PATH . 'includes/ace.class.php';

$ace = new ACE($db_name, $prefix);

define('DATA_DIR', $ace->data_dir());
define('IMAGE_DIR', $ace->image_dir());
/* 创建db对象 */
...
require_once ROOT_PATH . 'includes/ACEManager.class.php';
$aceman = new ACEManager();
